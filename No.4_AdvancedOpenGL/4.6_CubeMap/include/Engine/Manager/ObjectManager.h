...
private:
    ObjectManager(){
        ...
        for (auto position : container_position) {
            ...
            container->TransformScale(glm::vec3(0.5f));
        ...
        /* 天空盒 */
        skybox = new Skybox("skybox", MaterialManager::GetInstance().skybox_material, NULL);
    }
...
public:
    ...
    void RenderTick(Material* choose_material = NULL){
        ...
        /* 4. 最后绘制天空盒 */
        skybox->RenderTick(CameraManager::GetInstance().main_camera, choose_material);
    }
