...
/* 路径信息 */
static const std::string root_path = "E:/MyProject/GameEngine/OpenGL_Learning/No.3_ModelLoading/";
static const std::string shader_root_path = root_path + "shader/";
static const std::string resource_path = "E:/MyProject/GameEngine/OpenGL_Learning/resource/";
