...
public:
    void Run() {
        ...
        material_manager = new MaterialManager(shader_manager, texture_manager);
        object_manager = new ObjectManager(camera_manager, shader_manager, texture_manager, light_manager, material_manager);
